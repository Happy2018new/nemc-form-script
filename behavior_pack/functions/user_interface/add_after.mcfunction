...
editpopupform "user_interface/add_after_popup" content "return '您已成功添加表单，现在要编辑它吗？'"
...
editpopupform "user_interface/add_after_failed" content "return '表单添加失败，请检查提供的表单名称是否与已有表单重复？'"
