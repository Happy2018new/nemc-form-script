...
<img width="450" height="400" alt="Image" src="../images/sample_modal_form_3.png" />

---

玩家在填写完**模态表单**后，可以通过点击“提交”按钮来提交填写的内容。<br/>
当然，玩家同样可以通过点击屏幕右上角的叉号来关闭它。<br/>
这意味着玩家在点击“提交”或叉号后，**模态表单**将被立即关闭。